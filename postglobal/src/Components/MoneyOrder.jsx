        ...
        <div className='col-sm-8'>
           ...
           <h6 style={{fontStyle: 'italic' ,  marginTop : '2px'}}><b>Money Order</b></h6>
                ...
                <input type="text" id="txtmovalue" style={{marginLeft: '50px'}}/>
                 ...
                 {/* <img src="images/Sanction.JPG" style={{width}}/> */}
                 <br/>
         ...
         <div className="star mt-2" style={{border : '1px solid black' , padding: '10px'}}>
           ...
           <input id='txtRemitterMobile' style={{width: '180px',marginLeft: '5px', marginBottom:'4px'}}/><br/>
            ...
            <table style={{borderCollapse:'collapse', width: '300px', marginLeft: '15px'}}>
              ...
              <tbody>
                {data.map((item , index) => (
                   ...
                   <td style={{ border: '1px solid #333', padding: '4px' }}>{item.Description}</td>
                   <td style={{ border: '1px solid #333', padding: '4px' }}>{item.Tariff}</td>
                   <td style={{ border: '1px solid #333', padding: '4px' }}>{item.VAT}</td>
                   </tr>
                )
                )}
              </tbody>
